<template>
    <div class="nav">
        <div class="list">
            ...
            <div class="img" v-show="showTwo"><img src="../../static/userImage.jpg"></div>
            <span class="name" v-show="showTwo" v-on:click="show($event)" >{{this.$store.state.mine.getMineBaseMsg.msg.name}}</span>
            <ul>
